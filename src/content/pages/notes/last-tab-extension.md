...
description: "A minimal Chrome extension for switching to your last used tab using a customizable keyboard shortcut, providing Cmd+Tab functionality for browser tabs"
---
...
2. To customize the keybind go to `chrome://extensions/shortcuts`
